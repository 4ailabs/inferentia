  ...
  return (
    <main className="min-h-screen bg-paper text-ink">
        ...
        <div className="mx-auto max-w-[1480px] px-6 md:px-10">
          <div className="flex items-end justify-between py-5">
            <div className="flex items-end gap-6">
              ...
              <p className="eyebrow">
                {locale === "es"
                  ? "Clínico · Figura iii.c · Programa nutricional"
                  : "Clinician · Figure iii.c · Nutritional program"}
              </p>
            </div>
            <LocaleToggle locale={locale} pathname="/clinico/programa" search={sp} />
          </div>
        </div>
      ...
      <article className="mx-auto max-w-[1480px] px-6 md:px-10 py-10 pb-16">
        <ProgramaClient initialLocale={locale} />
      </article>
